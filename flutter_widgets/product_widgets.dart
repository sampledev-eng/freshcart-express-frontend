...
class CompactProductGrid extends StatelessWidget {
  final List<Product> products;
  final void Function(Product product) onAdd;
  final void Function(Product product) onRemove;

  const CompactProductGrid({Key? key, required this.products, required this.onAdd, required this.onRemove}) : super(key: key);
